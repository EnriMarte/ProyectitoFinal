...
public class fragmentDiagnosticos extends Fragment {
            ...
            public void onClick(View v) {
                getFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container,
                                new datosDiagnosticos(), "datosDiagnosticosTag")
                        .addToBackStack("datosDiagnosticosTag").commit();
            }
        });
    ...
    private static String url = "http://192.99.56.223/basedd/traeDiagnosticos.php";
